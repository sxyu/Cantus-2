# Cantus 2.0 
*Cantus* is a lightweight yet powerful mathematical language. This is a basic *Cantus* language evaluator and graphing calculator based on the .Net Framework. Type in an expression or run a script, and it will give you the result in no time.
...
### What you can do with Cantus:
  ...
  - Customize
    ...
    - Add initialization scripts to customize the calculator
  - Graph **cartesian**, **inverse**, **polar**, or **parametric** functions as well as **slope fields**
...
* `!` is the factorial operator
	* The logical not operator is just `not` 
	* The bitwise not operator is `~` 
* `|` is the absolute value operator
	* The logical or operator is just `or`  
...
* `^` is the exponentiation operator
	* The logical xor operator is just `xor`  
